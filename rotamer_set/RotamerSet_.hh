...
protected:
	...
	void build_rotamers_for_concrete(
        ...
        // jag, We filter the massive amount of water rotamers by:  yumeng
        //  1: eliminating rotamers with overlaps 
        //  2: uniformly only keeping a maximum number of rotamers (water_rotamers_cap, def=500)
        void
...
private:
	...
	void build_tp3_water_rotamers(
        ...
        void build_filtered_tp3_water_rotamers( // jag   yumeng
                pose::Pose const & pose,
                scoring::ScoreFunction const & scorefxn,
                task::PackerTask const & task,
                chemical::ResidueTypeCOP concrete_residue,
