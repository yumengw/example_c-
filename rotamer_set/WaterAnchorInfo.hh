...
public:
	...
	void          // jag    yumeng
	rotamer_bonds( std::string bonds );
...
private:
	...
	AA aa_;
	Size nstep_;
	bool enforced_;     // jag, If true, the water molecule is forced to stay near the protein (present)    yumeng
	std::string rotamer_bonds_;   // jag,  Describes the number of hbonds the rotamers it builds will have with the protein   yumeng
};
